...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  5 21:18:13 2022
...
app.layout = html.Div([
    dash_table.DataTable(
        ...
        columns=[
            ...
            if i == "Teams" or i == "Wins" or i == "Losses" or i == "Ties" or i == "Rank"
...
def update_bar(all_rows_data, slctd_row_indices, slct_rows_names, slctd_rows,
    ...
    if "Teams" in dff and "Wins" in dff:
        return [
            dcc.Graph(id='bar-chart',
                      figure=px.bar(
                          ...
                          x="Teams",
                          y='Wins',
                          labels={"did online course": "% of Pop took online course"}#Skal måske fjernes
...
def update_map(all_rows_data, slctd_row_indices):
    ...
    if "Teams" in dff and "Wins" in dff and "Losses" in dff:
        return [
